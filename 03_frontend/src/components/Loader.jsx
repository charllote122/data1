...
export const PageLoader = ({ text = 'Loading page...' }) => (
    <Loader size="lg" fullPage={true} text={text} variant="spinner" />
);

export const ButtonLoader = ({ size = 'sm' }) => (
    <Loader size={size} showText={false} variant="spinner" />
);

export const ContentLoader = ({ text = 'Loading content...' }) => (
    <Loader size="md" variant="pulse" text={text} />
);

export const HealthLoader = ({ text = 'Analyzing health data...' }) => (
    <Loader size="lg" variant="logo" text={text} />
);

export const PredictionLoader = ({ text = 'Calculating your risk...' }) => (
    <Loader size="lg" variant="bounce" text={text} showText={true} />
);
